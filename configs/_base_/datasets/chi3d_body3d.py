dataset_info = dict(
    dataset_name='chi3d_pose_3d',
    paper_info=dict(
        author='Fieraru, Mihai and Zanfir, Mihai and Oneata, Elisabeta'
        'and Popa, Alin-Ionut and Olaru, Vlad and Sminchisescu, Cristian',
        title='Three-Dimensional Reconstruction of Human Interactions',
        container='The IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR)',
        year='2020',
        homepage='https://ci3d.imar.ro/home',
    ),
    keypoint_info={
        0:
